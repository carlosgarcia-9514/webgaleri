...
<h1 style="color: yellow; font-family: time-new roman; font-size: 80px; text-align:center;"> BIENVENIDOS  <br> WEB <br> GALERI </h1>
  ...
  <form class="form-signin" method="post" action="../controlador/accion/act_loginartista.php">
	<h1 class="h3 mb-3 font-weight-normal">Login Artista</h1>
	...
	<div style="width:352px; height:48px; margin: 10px 0;" class="g-signin2" data-onsuccess="onSignIn"></div>
