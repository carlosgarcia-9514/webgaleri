...
class UsuarioDAO {
	 ...
	 public function autenticarUsuario($correo, $password){
        ...
        $data_table= $data_source->ejecutarConsulta("SELECT * FROM artista WHERE correo = :correo AND password = :password",array(':correo'=>$correo,':password'=>$password));
