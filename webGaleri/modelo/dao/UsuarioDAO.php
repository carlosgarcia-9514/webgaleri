...
class UsuarioDAO {
	 ...
	 public function autenticarUsuario($correo, $password){
        ...
        $data_table= $data_source->ejecutarConsulta("SELECT * FROM comprador WHERE correo = :correo AND password = :password",array(':correo'=>$correo,':password'=>$password));
        ...
        if(count($data_table)==1){
            ...
            foreach($data_table as $indice => $valor){
                ...
                $usuario = new Usuario(
                        $data_table[$indice]["id_comprador"],
    ...
    public function registrarUsuario(Usuario $usuario){
        ...
        $stmt1 = "INSERT INTO usuario VALUES (NULL,:nombre,:correo,:password,:telefono)"; 
